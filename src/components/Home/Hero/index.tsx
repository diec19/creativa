...
const Hero = () => {
    ...
    return (
        <section id="home-section" className='py-15 p-15 w-full fade-in relative'ref={sectionRef}>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 items-center'>
                    <div className='col-span-6'>
                        <h1 className="text-4xl lg:text-7xl font-semibold mb-5 text-black dark:text-white md:4px lg:text-start text-center">
                            Libreria y sublimacion
                        </h1>
                        <p className='text-black/55 dark:text-white/50 lg:text-lg font-normal mb-10 lg:text-start text-center'>Contamos con variedades de utiles escolares<br /> marcas y calidad.</p>
                    ...
                    <div className='col-span-6 flex justify-center relative'>
                        <div className='flex bg-white p-2 gap-5 items-center bottom-10 left-10 rounded-xl absolute'>
                            <Image src={'/images/hero/checked.svg'} alt="pizza-image" width={68} height={68} />
                            <p className='text-lg font-normal'>Mas de 500+ <br /> articulos.</p>
                        </div>
                        <Image src="/images/hero/banner-escolar.png" alt="nothing" width={1000} height={805} />
                    </div>
                </div>
            </div>
        </section>
